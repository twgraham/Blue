...
namespace Blue.BlueZ.DBus.Mesh
{
	...
	internal interface INode1 : IDBusObject
	{
		/// <summary>
	...
	internal interface IApplication1 : IDBusObject
	{
		/// <summary>
	...
	internal interface IElement1 : IDBusObject
	{
		/// <summary>
	...
	internal interface IAttention1 : IDBusObject
	{
		/// <summary>
	...
	internal interface IProvisionAgent1 : IDBusObject
	{
		/// <summary>
